#!/usr/bin/env node
/**
 * Push inbox mockup (homepage hero) to server, rebuild frontend, restart PM2.
 */
...
const fileRel = 'components/marketing/inbox-mockup.tsx';
...
conn.on('ready', async () => {
  try {
    ...
    console.log('Done. Homepage inbox mockup updated.');
  } catch (e) {
