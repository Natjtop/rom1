#!/usr/bin/env node
/**
 * Push features/live-chat page to server, rebuild frontend, restart PM2.
 */
...
const fileRel = 'app/(marketing)/features/live-chat/page.tsx';
...
conn.on('ready', async () => {
  try {
    ...
    console.log('Done. Live chat page updated.');
  } catch (e) {
