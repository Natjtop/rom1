#!/usr/bin/env node
/**
 * Push logo component to server, rebuild frontend, restart PM2.
 */
...
const fileRel = "components/marketing/logo.tsx";
...
conn.on("ready", async () => {
  try {
    ...
    console.log("Done. Logo component updated on server.");
  } catch (e) {
